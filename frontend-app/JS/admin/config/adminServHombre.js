...
function configurarEventos() {
    ...
    async function cargarServicios() {
        try {
            const response = await fetch(`${API_BASE_URL}/servHombre/verServHombres`);
    ...
    async function cargarServicioParaEditar(id) {
        try {
            const response = await fetch(`${API_BASE_URL}/servHombre/hombres/${id}`);
            const data = await response.json();
    ...
    async function manejarEnvioFormulario(e) {
        ...
        try {
            let response;
            if (servicioId.value) {
                response = await fetch(`${API_BASE_URL}/servHombre/actualizarHombre/${servicioId.value}`, {
                    method: 'PUT',
                    headers: {
                ...
                response = await fetch(`${API_BASE_URL}/servHombre/hombres`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
