document.addEventListener('DOMContentLoaded', function() {
    ...
    async function cargarServicios() {
        try {
            const response = await fetch(`${API_BASE_URL}/servMujer/verServMujeres`);
    ...
    async function cargarServicioParaEditar(id) {
        try {
            const response = await fetch(`${API_BASE_URL}/servMujer/mujeres/${id}`);
            const data = await response.json();
    ...
    async function manejarEnvioFormulario(e) {
        ...
        try {
            let response;
            if (servicioId.value) {
                response = await fetch(`${API_BASE_URL}/servMujer/actualizarMujer/${servicioId.value}`, {
                    method: 'PUT',
                    headers: {
                ...
                response = await fetch(`${API_BASE_URL}/servMujer/mujeres`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
